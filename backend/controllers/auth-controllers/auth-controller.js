...
const User = require('../../models/auth-models/auth-models.js');
const Counter = require('../../models/auth-models/counter-models.js');
const LoginUser = require('../../models/auth-models/login-models.js');
const saltRounds = 10;
